...
export const getHwReturnAddresses     = ()          => req('GET',   '/handwrytten/return-addresses')
export const addHwReturnAddress       = (data)      => req('POST',  '/handwrytten/return-addresses', data)
export const updateHwReturnAddress    = (id, data)  => req('PUT',   `/handwrytten/return-addresses/${id}`, data)
export const setDefaultHwReturnAddress = (id)       => req('PATCH', `/handwrytten/return-addresses/${id}/default`)
export const deleteHwReturnAddress    = (id)        => req('DELETE',`/handwrytten/return-addresses/${id}`)
