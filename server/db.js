...
const migrations = [
  ...
  // Deal-level underwriting details + lease abstract (filled by the pipeline
  // deal-detail parser; edited inline on the deal page).
  `ALTER TABLE deals ADD COLUMN noi                REAL`,
  `ALTER TABLE deals ADD COLUMN list_price         REAL`,
  `ALTER TABLE deals ADD COLUMN building_size      REAL`,
  `ALTER TABLE deals ADD COLUMN year_built         INTEGER`,
  `ALTER TABLE deals ADD COLUMN property_type      TEXT`,
  `ALTER TABLE deals ADD COLUMN lease_type         TEXT`,
  `ALTER TABLE deals ADD COLUMN guarantor          TEXT`,
  `ALTER TABLE deals ADD COLUMN permitted_use      TEXT`,
  `ALTER TABLE deals ADD COLUMN lease_commencement TEXT`,
  `ALTER TABLE deals ADD COLUMN lease_expiration   TEXT`,
  `ALTER TABLE deals ADD COLUMN lease_term         TEXT`,
  `ALTER TABLE deals ADD COLUMN base_rent          TEXT`,
  `ALTER TABLE deals ADD COLUMN annual_rent        REAL`,
  `ALTER TABLE deals ADD COLUMN rent_escalations   TEXT`,
  `ALTER TABLE deals ADD COLUMN renewal_options    TEXT`,
  `ALTER TABLE deals ADD COLUMN renewal_notice     TEXT`,
